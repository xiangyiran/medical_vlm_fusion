...
class ConcatenationFusionModel(TwoTowerBase):
    """Baseline that concatenates pooled image and text features before classification."""
    ...
    def __init__(self, text_model_name, vision_model_name, num_labels, hidden_dim=512, dropout=0.1, freeze_image_encoder=True, freeze_text_encoder=True):
        """Create a two-tower encoder and a classifier over concatenated features."""
    ...
    def forward(self, pixel_values, input_ids, attention_mask):
        """Fuse modalities by feature concatenation."""
